...
var CAM_LABELS = {
    ...
    hallE: 'CAM 3 - SUPPLY CLOSET',
    hallW: 'CAM 2A - W. HALL',
    hallW_corner: 'CAM 2B - W. HALL CORNER',
    hallE_corner: 'CAM 4A - E. HALL',
    kitchen: 'CAM 6 - KITCHEN',
    stage_left: 'CAM 4B - E. HALL CORNER',
...
function drawCamBg(cam, w, h) {
    ...
    if (cam === 'stage') {
        ...
        c.fillStyle = '#ffcc00';
        c.font = 'bold ' + Math.floor(h * 0.08) + 'px Arial';
        c.textAlign = 'center';
        ...
        c.fillRect(w * 0.62, h * 0.45, w * 0.3, h * 0.15);
        c.fillStyle = '#c8a882';
        for (var i = 0; i < 6; i++) { c.fillRect(w * (0.15 + i * 0.12), h * 0.2, w * 0.08, h * 0.08); }
        c.fillStyle = '#ff6600';
        c.beginPath();
        c.arc(w * 0.15, h * 0.1, h * 0.04, 0, Math.PI * 2);
        c.fill();
        c.beginPath();
        c.arc(w * 0.85, h * 0.1, h * 0.04, 0, Math.PI * 2);
        c.fill();
        ...
        c.textAlign = 'center';
        c.fillText('*** NO AUDIO ***', w / 2, h * 0.55);
        ...
        c.beginPath();
        c.moveTo(0, 0);
        c.lineTo(w * 0.35, h * 0.3);
        c.lineTo(w * 0.35, h * 0.55);
        c.lineTo(0, h * 0.55);
        c.fill();
        c.fillStyle = '#9a7663';
        c.beginPath();
        c.moveTo(w, 0);
        c.lineTo(w * 0.65, h * 0.3);
        c.lineTo(w * 0.65, h * 0.55);
        c.lineTo(w, h * 0.55);
        c.fill();
        c.fillStyle = '#4a3a2a';
        c.fillRect(w * 0.35, h * 0.25, w * 0.3, h * 0.35);
        c.fillStyle = '#1a1a1a';
        c.fillRect(w * 0.4, h * 0.3, w * 0.2, h * 0.25);
        c.fillStyle = 'rgba(255,200,0,0.1)';
        c.fillRect(w * 0.1, h * 0.05, w * 0.2, h * 0.1);
        ...
        c.fillStyle = '#2a1a1a';
        c.fillRect(w * 0.4, h * 0.3, w * 0.2, h * 0.25);
        c.fillStyle = 'rgba(200,150,50,0.15)';
        c.fillRect(w * 0.08, h * 0.1, w * 0.15, h * 0.15);
        ...
        c.fill();
        c.fillStyle = '#4a3a2a';
        c.fillRect(w * 0.52, h * 0.15, w * 0.25, h * 0.4);
        c.fillStyle = '#1a1a1a';
        c.fillRect(w * 0.58, h * 0.22, w * 0.13, h * 0.26);
        c.fillStyle = '#cc8844';
        c.beginPath();
        c.arc(w * 0.15, h * 0.15, h * 0.04, 0, Math.PI * 2);
        c.fill();
        c.beginPath();
        c.arc(w * 0.85, h * 0.2, h * 0.04, 0, Math.PI * 2);
        c.fill();
        ...
        c.beginPath();
        c.moveTo(0, h * 0.6);
        c.lineTo(w * 0.45, h * 0.5);
        c.lineTo(w * 0.45, h);
        c.lineTo(0, h);
        c.fill();
        c.fillStyle = '#5a4a3a';
        c.fillRect(w * 0.5, h * 0.15, w * 0.28, h * 0.4);
        c.fillStyle = '#2a1a1a';
        c.fillRect(w * 0.57, h * 0.22, w * 0.14, h * 0.26);
        c.fillStyle = '#dd8844';
        c.beginPath();
        c.arc(w * 0.12, h * 0.18, h * 0.045, 0, Math.PI * 2);
        c.fill();
