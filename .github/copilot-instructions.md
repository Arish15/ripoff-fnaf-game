...
|---|---|---|
| `doorAudio` | `door.mp3` / `door.ogg` | `toggleDoor()` and `toggleLight()` |
| `jumpScareAudio` | `jumpscare.mp3` / `jumpscare.ogg` | `triggerGameOver()` |
| `powerOutAudio` | `powerout.mp3` / `powerout.ogg` | Power reaching 0% |
| `successAudio` | `success.mp3` / `success.ogg` | `endNight()` |
